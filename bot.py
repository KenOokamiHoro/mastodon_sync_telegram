...
class TransferBot:
    def __init__(self):
        ...
        self.dispatcher.add_handler(MessageHandler(Filters.photo,actions.photo))
        self.dispatcher.add_handler(MessageHandler(Filters.document,actions.document))
        self.dispatcher.add_handler(MessageHandler(Filters.text,actions.text))
        ...
        self.dispatcher.add_handler(MessageHandler(filters.always_true,actions.updates))
        # Start bot
    def start(self):
